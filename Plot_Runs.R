...
for (file in input_files) {
  ...
  # ---- Generate Plots ----
  p_pace <- plot_km_splits(summaries$km_splits, total_time_formatted, start_date, sizes)
  p_hr_line <- plot_hr_line(summaries$hr_df_avg, total_time_formatted, start_date, max_km, sizes)
  p_hr_stacked <- plot_hr_stacked(summaries$hr_stacked_bar, total_time_formatted, start_date, sizes)
